...
そこからWeb制作の世界に興味を持ち学習を始めました。\
その後約２年間プログラミングの基礎や応用を徹底的に集中的に学び、現在ではWebサイト、Webアプリを複数制作完了済みです。\
よろしくお願い致します！
...
- [解説及びリポジトリ](https://github.com/riotokashiki/ryotokashiki-portfolio/tree/main/my-portfolio/weather_app2)

## 使用した技術スタック

使用した言語：React.js/jQuery/JavaScript/HTML/CSS\
